...
const BusinessCard = ({
  ...
  if (SelectedCard && SelectedCard.id)
    return (
      <div className="w-full bg-customSecondary relative rounded-[6px]">
        <div className="bg-customThird w-full h-[72px] relative">
          <div className="w-[72px] h-[72px] bg-customSecondary border border-customAccent rounded-[4px] absolute top-[16px] left-[16px] flex items-center justify-center shadow-md">
            <LocalBussLogo />
          </div>
        </div>
        ...
        <div className="flex flex-col gap-[16px] p-[40px_16px_16px]">
          ...
          <div className="flex gap-[6px] items-center">
            ...
            <span className="font-medium text-[14px] text-customPrimary">
          ...
          <div className="flex gap-[6px] items-center">
            ...
            <a
              ...
              className="font-medium text-[14px] text-customPrimary"
            >
        ...
        <div
          ...
          className="cursor-pointer absolute top-[12px] right-[12px] size-[32px] rounded-[50%] border border-customAccent bg-customSecondary flex justify-center items-center"
        >
          <svg
            width="14"
            height="16"
