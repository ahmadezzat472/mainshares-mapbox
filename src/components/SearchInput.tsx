  ...
  return (
    <div
      className={`flex items-center mr-[1px] gap-[10px] border ${
        isActive ? "border-customPrimaryDark" : "border-customAccent"
    ...
    >
      ...
      <input
        ...
        className="w-full md:m-auto flex-grow text-customPrimaryDark font-medium bg-transparent outline-none placeholder:text-customPrimaryLight placeholder:font-medium "
      />
